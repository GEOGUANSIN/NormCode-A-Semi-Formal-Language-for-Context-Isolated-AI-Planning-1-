...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.62\textwidth]{figures/nc_compilations_ncs.png}
  \caption{NC~Compilations plan (\texttt{.ncds} sketch): five top-level inferences map
    directly onto the four pipeline stages plus output reporting.
...
is self-consistent; it can run the compilation of itself; (2)~\textbf{Improvement through revision} ---
improving the compilation pipeline is abstract case revision at the meta-level;
(3)~\textbf{Recursive retention} --- each improvement enriches the case library. Scope and limits of automated compilation are discussed in
