...
(the NormCode~Compilations plan), but it is not a universal compiler. What it produces
...
The NormCode~Compilations \texttt{.ncds} is shown alongside the other production plans in
Fig.~\ref{fig:plans}.
