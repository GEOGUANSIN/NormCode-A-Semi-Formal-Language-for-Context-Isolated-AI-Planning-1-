...
def _build_value_concept_entry(name: str, data: dict, inferred_concepts: set) -> dict:
    ...
    natural_name_ann = get_annotation_value(attached_comments, "natural_name")
    ...
    return {
        ...
        "natural_name": natural_name_ann if natural_name_ann else name,
    }
